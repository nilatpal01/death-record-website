        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.data.user.role == "admin") {
              (0, _alert.showAlert)('success', 'logged in successfully! Verifier');
              window.setTimeout(function () {
                location.assign('/admin-overview');
              }, 1500);
            } else if (res.data.data.user.role == "approver") {
              (0, _alert.showAlert)('success', 'logged in successfully! Approver');
              window.setTimeout(function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'account has been created successfully!');
              window.setTimeout(function () {
                location.assign('/userOverview');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createForm4.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createForm4 = void 0;
...
var createForm4 = /*#__PURE__*/function () {
  ...
  return function createForm4(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15, _x16) {
    return _ref.apply(this, arguments);
  };
}();

exports.createForm4 = createForm4;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createForm4a.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createForm4a = void 0;
...
exports.createForm4a = createForm4a;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"verification.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.rejection4a = exports.rejection4 = exports.verification4a = exports.approver = exports.verification4 = void 0;
...
var verification4 = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, isVerified, rejectReason) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function verification4(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var approver = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id, isApproved, rejectReason) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'form has been approved!');
              window.setTimeout(function () {
                location.assign('/approver-overview');
              }, 1500);
            }
  ...
  return function approver(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
...
var verification4a = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(id, isVerified, rejectReason) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
  ...
  return function verification4a(_x7, _x8, _x9) {
    return _ref3.apply(this, arguments);
  };
}();
...
var rejection4 = /*#__PURE__*/function () {
  ...
  return function rejection4(_x10, _x11) {
...
var rejection4a = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(id, rejectReason) {
    var res;
  ...
  return function rejection4a(_x12, _x13) {
...
var _createForm = require("./createForm4");

var _updateSettings = require("./updateSettings");

var _createForm4a = require("./createForm4a");
...
var postForm4 = document.querySelector('.form-create-form4');
...
if (postForm4) {
  postForm4.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (postForm4a) {
  postForm4a.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (accept) {
  accept.addEventListener('click', function (e) {
    ...
    var isVerified = true;
    var rejectReason = "form has been corrected";
    (0, _verification.verification4)(id, isVerified, rejectReason);
  });
}
...
if (approve) {
  approve.addEventListener('click', function (e) {
    ...
    var isApproved = true;
    var rejectReason = "form has been corrected";
    (0, _verification.approver)(id, isApproved, rejectReason);
  });
}
...
if (accept4a) {
  accept4a.addEventListener('click', function (e) {
    ...
    var isVerified = true;
    var rejectReason = "form has been corrected";
    (0, _verification.verification4a)(id, isVerified, rejectReason);
  });
}
